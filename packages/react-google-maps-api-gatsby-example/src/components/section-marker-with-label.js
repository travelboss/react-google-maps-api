...
import ExampleMarkerWithLabel from '../examples/example-marker-with-label'

import { shapeExampleStyles } from './styles'

const SectionMarkerWithLabel = ({ markerWithLabel }) =>
  markerWithLabel
    ? (
      <ExampleMarkerWithLabel
        styles={shapeExampleStyles}
      />
    )
    : (<></>)

SectionMarkerWithLabel.propTypes = {
  markerWithLabel: PropTypes.bool.isRequired
}
